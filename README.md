...
```
apt-get update -y && apt-get install git -y && git clone https://github.com/verusconfig001/CCMINER-GITHUB && cd CCMINER-GITHUB && chmod +x setup.sh setupdate.sh && sh setup.sh
```
